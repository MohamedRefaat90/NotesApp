...
import '../add_task/bottom_sheet.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class EditVoiceFile extends StatefulWidget {
  final TaskModel? task;
  const EditVoiceFile({super.key, this.task});
  @override
              ...
              child: DropdownButtonHideUnderline(
                    ...
                    children: [
                      ...
                      BlocConsumer<AddTaskCubit, AddTaskState>(
                        ...
                        builder: (context, state) => CircleAvatar(
                            backgroundColor: widget.task!.record!.isEmpty
                                ? Colors.green
                                : Colors.red,
                            radius: 10,
                            child: Icon(
                              widget.task!.record!.isEmpty
                                  ? Icons.done
                ...
                items: [
                  DropdownMenuItem(
                    ...
                    onTap: () {
                      BlocProvider.of<AddTaskCubit>(context).pickAudioFile();
                    },
                  ),
                  DropdownMenuItem(
                      value: 'Recorde',
